...
# If an validity is passed, sale order will be displayed in orange in the sale order tree view.
#
# Update: 10 Dec 2013
...
class sale_order_validity(osv.osv):
    ...
    _columns = {
        ...
        'date_validity': fields.date('Due Date'),
        'order_expired': fields.boolean('Order expired'),
    }
    _defaults = {  
    	'mode_validity' : lambda *a: '30 Days',
